...
from geospacelab.datahub.sources.isee import isee_database
from geospacelab import preferences as prf
import geospacelab.toolbox.utilities.pydatetime as dttool
import geospacelab.toolbox.utilities.pybasic as basic
import geospacelab.toolbox.utilities.pylogging as mylog
from geospacelab.datahub.sources.isee.gnss.tecmap.loader import Loader as default_Loader
from geospacelab.datahub.sources.isee.gnss.tecmap.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.isee.gnss.tecmap.variable_config as var_config


default_dataset_attrs = {
    'database': isee_database,
    'facility': 'GNSS',
    'product': 'TEC',
    'data_file_type': 'ATEC',
    'data_root_dir': prf.datahub_data_root_dir / 'ISEE' / 'GNSS' / 'TEC',
    'allow_load': True,
    'allow_download': True,
    ...
    def search_data_files(self, **kwargs):
        ...
        for i in range(diff_days + 1):
            ...
            for hh in range(24):
                ...
                file_patterns = [this_time.strftime("%Y%m%d%H"), self.data_file_type.lower(), ]
                # remove empty str
