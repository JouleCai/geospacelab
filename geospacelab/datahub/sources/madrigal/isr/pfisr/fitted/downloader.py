...
class Downloader(DownloaderBase):
    ...
    def __init__(
        ...
        exclude_file_type_patterns = EXCLUDE_FILE_TYPE_PATTERNS if exclude_file_type_patterns is None else exclude_file_type_patterns
        data_product = 'vi'
        data_file_root_dir = prf.datahub_data_root_dir / 'Madrigal' / 'PFISR' if data_file_root_dir is None else data_file_root_dir
        super().__init__(
