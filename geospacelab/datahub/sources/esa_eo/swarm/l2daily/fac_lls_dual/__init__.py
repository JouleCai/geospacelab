...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.fac_lls_dual.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.fac_lls_dual.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.fac_lls_dual.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'instrument': 'MAG',
    'product': 'FAC_LLS_DUAL',
    'data_file_ext': '.cdf',
    'product_version': 'latest',
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'FAC_LLS_DUAL',
    'allow_load': True,
    'allow_download': True,
...
class Dataset(SwarmDataset):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs.update(sat_id='AC')
        super().__init__(**kwargs)
        
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', ['FLAG_BIN_IND', ])
