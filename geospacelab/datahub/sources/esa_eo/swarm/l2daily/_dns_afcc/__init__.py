...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily._dns_afcc.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily._dns_afcc.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily._dns_afcc.variable_config as var_config
...
class Dataset(datahub.DatasetSourced):
    def __init__(self, **kwargs):
        ...
        self.product = kwargs.pop('product', 'DNS_ACC')
