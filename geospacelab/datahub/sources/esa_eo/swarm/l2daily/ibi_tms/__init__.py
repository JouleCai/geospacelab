...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.ibi_tms.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.ibi_tms.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.ibi_tms.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'IBI_TMS',
    'allow_load': True,
    'allow_download': True,
...
class Dataset(SwarmDataset):
    ...
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', ['FLAG_BIN_IND', 'FLAG_B_BIN_IND', 'FLAG_q_BIN_IND', 'FLAG_F_BIN_IND'])
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['IBI' + self.sat_id.upper(), 'TMS']
