...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.whi_evt.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.whi_evt.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.whi_evt.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'WHI_EVT',
    'allow_load': True,
    'allow_download': True,
...
class Dataset(SwarmDataset):
    ...
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', [])
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['WHI' + self.sat_id.upper(), 'EVT']
