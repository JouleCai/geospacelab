...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.efi_tie.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.efi_tie.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.efi_tie.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'EFI_TIE',
    'allow_load': True,
    'allow_download': True,
...
default_variable_names = [
    ...
    'T_n_MSIS',
    'FLAG_T_i_DRIFT',
    'FLAG_T_i_DRIFT_MODEL',
    'FLAG_T_i_DRIFT_BIN_AUX',
    'FLAG_T_i_DRIFT_BIN_IND',
    'FLAG_T_i_DRIFT_MODEL_BIN_AUX',
    'FLAG_T_i_DRIFT_MODEL_BIN_IND',
    ]
...
class Dataset(SwarmDataset):
    ...
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', ['FLAG_T_i_DRIFT_BIN_IND', 'FLAG_T_i_DRIFT_MODEL_BIN_IND', ])
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['EFI' + self.sat_id.upper(), 'TIE']
