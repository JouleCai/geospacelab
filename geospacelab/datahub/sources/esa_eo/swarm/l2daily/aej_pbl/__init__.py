...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.aej_pbl.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.aej_pbl.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.aej_pbl.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'AEJ_PBL',
    'allow_load': True,
    'allow_download': True,
