...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.mit_tec.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.mit_tec.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.mit_tec.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Level2daily' / 'MIT_TEC',
    'allow_load': True,
    'allow_download': True,
...
class Dataset(SwarmDataset):
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['MIT' + self.sat_id.upper(), 'TEC']
