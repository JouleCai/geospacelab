...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Total Electron Content of MIT minimum'
var.label = r'TEC'
var.unit = r'TECU'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Change in TEC at the poleward wall of MIT dvided by QD LAT difference'
var.label = r'PW Gradient'
var.unit = r'TECU/deg'
var.unit_label = r'TECU/deg'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Change in TEC at the equatorward wall of MIT dvided by QD LAT difference'
...
var = Var(name=var_name, ndim=2, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Total Electron Content of each data point in the MIT detection'
var.label = r'TEC'
var.unit = r'TECU'
var.unit_label = r'TECU'
var.group = r'TEC'
