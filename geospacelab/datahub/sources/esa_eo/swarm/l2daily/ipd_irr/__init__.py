...
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.ipd_irr.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.l2daily.ipd_irr.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.l2daily.ipd_irr.variable_config as var_config
...
class Dataset(SwarmDataset):
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['IPD' + self.sat_id.upper(), 'IRR']
