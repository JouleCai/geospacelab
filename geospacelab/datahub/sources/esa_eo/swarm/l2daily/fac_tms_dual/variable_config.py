...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Ionospheric radial current (IRC)'
var.label = r'$j_r^{dual}$'
var.unit = 'muA/m^2'
var.unit_label = r'$\mu$A/m$^2$'
var.group = r'$j$'
var.error = var_name + '_err'
var.depends = {0: depend_0}
# set plot attrs
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Field-aligned current (FAC)'
var.label = r'$j_{FA}^{dual}$'
var.unit = 'muA/m^2'
var.unit_label = r'$\mu$A/m$^2$'
var.group = r'$j$'
var.error = var_name + '_err'
...
var.depends = {
    0: depend_0,
    1: {'DIGIT Index': 'FLAG_F_DIGIT_IND'},
    }
# set plot attrs
plot_config = var.visual.plot_config
plot_config.config(**default_plot_config)
...
# set axis attrs
axis = var.visual.axis
axis[1].data = "@d.FLAG_F_DIGIT_IND"
# axis[1].lim = [None, None]
axis[1].label = 'DIGIT Index'
axis[1].unit = ''
axis[2].value = "@v.value"
...
var.depends = {
    0: depend_0,
    1: {'DIGIT Index': 'FLAG_B_DIGIT_IND'},
    }
# set plot attrs
plot_config = var.visual.plot_config
plot_config.config(**default_plot_config)
...
# set axis attrs
axis = var.visual.axis
axis[1].data = "@d.FLAG_B_DIGIT_IND"
# axis[1].lim = [None, None]
axis[1].label = 'DIGIT Index'
axis[1].unit = ''
axis[2].value = "@v.value"
...
var.depends = {
    0: depend_0,
    1: {'DIGIT Index': 'FLAG_q_DIGIT_IND'},
    }
# set plot attrs
plot_config = var.visual.plot_config
plot_config.config(**default_plot_config)
...
# set axis attrs
axis = var.visual.axis
axis[1].data = "@d.FLAG_q_DIGIT_IND"
# axis[1].lim = [None, None]
axis[1].label = 'DIGIT Index'
axis[1].unit = ''
axis[2].value = "@v.value"
