...
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_lp_fp.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_lp_fp.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_lp_fp.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Advanced' / 'EFI_LP_FP',
    'allow_load': True,
    'allow_download': True,
...
class Dataset(SwarmDataset):
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['EFI' + self.sat_id.upper(), 'LP', 'FP']
