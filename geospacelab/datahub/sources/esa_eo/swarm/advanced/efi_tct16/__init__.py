...
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_tct16.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_tct16.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_tct16.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Advanced' / 'EFI_TII' / 'TCT16',
    'allow_load': True,
    'allow_download': True,
...
default_variable_names = [
    'SC_DATETIME', 'SC_GEO_LAT', 'SC_GEO_LON', 'SC_GEO_r', 'SC_GEO_R',
    'SC_QD_LAT', 'SC_QD_MLT',
    ...
    'QUALITY_FLAG_BIN_AUX', 'QUALITY_FLAG_BIN_IND',
    'CALIB_FLAG_BIN_AUX', 'CALIB_FLAG_BIN_IND',
    ]
...
class Dataset(SwarmDataset):
    ...
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', ['QUALITY_FLAG_BIN_IND', 'CALIB_FLAG_BIN_IND'])
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['EFI' + self.sat_id.upper(), 'TCT16']
