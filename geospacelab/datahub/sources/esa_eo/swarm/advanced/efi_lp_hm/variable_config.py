...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Electron temperature from high-gain probe'
var.label = r'$T_e$ (HG)'
var.unit = 'K'
var.unit_label = r'K'
var.group = r'$T_e$'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Electron temperature from low-gain probe'
var.label = r'$T_e$ (LG)'
var.unit = 'K'
var.unit_label = r'K'
var.group = r'$T_e$'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Spacecraft potential from high-gain probe'
var.label = r'$V_{SC}$ (HG)'
var.unit = 'V'
var.unit_label = r'V'
var.group = r'SC Potential'
# var.error = var_name + '_err'
var.depends = {0: depend_0}
var.visual.plot_config.config(**default_plot_config)
var.visual.plot_config.style = '1noE'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Spacecraft potential from low-gain probe'
var.label = r'$V_{SC}$ (LG)'
var.unit = 'V'
var.unit_label = r'V'
var.group = r'SC Potential'
# var.error = var_name + '_err'
...
var = Var(name=var_name, ndim=1, variable_type='scalar', visual=visual)
# set variable attrs
var.fullname = 'Spacecraft velocity'
var.label = r'$v_{SC}$'
var.unit = 'km/s'
var.unit_label = r'km/s'
var.group = r'$v_{SC}$'
# var.error = var_name + '_err'
var.depends = {0: depend_0}
var.visual.plot_config.config(**default_plot_config)
