...
class Downloader(DownloaderSwarm):
    ...
    def __init__(
        ...
        file_class = 'PREL'
        product_level = '2'
        root_dir_remote = '/Advanced/Plasma_Data/2_Hz_Ion_Drift_Density_and_Effective_Mass_dataset'
        
        if data_file_root_dir is None:
            data_file_root_dir = prf.datahub_data_root_dir / "ESA" / "SWARM" / "Advanced" / "EFI_IDM" 
        root_dir_local = data_file_root_dir
        
        self._default_sub_dirs_remote = {
            'latest': ['New_version', ],
            'Older_baselines': ['Older_versions', ], 
        }
