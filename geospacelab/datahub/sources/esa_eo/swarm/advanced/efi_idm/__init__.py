...
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_idm.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_idm.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.advanced.efi_idm.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'data_root_dir': prf.datahub_data_root_dir / 'ESA' / 'SWARM' / 'Advanced' / 'EFI_IDM',
    'allow_load': True,
    'allow_download': True,
...
default_variable_names = [
    ...
    'M_i_eff_err',
    'FLAG_M_i_eff',
    'FLAG_M_i_eff_BIN_AUX',
    'FLAG_M_i_eff_BIN_IND',
    'M_i_eff_model',
    'v_i',
    'v_i_err',
    'FLAG_v_i',
...
class Dataset(SwarmDataset):
    ...
    def load_data(self, **kwargs):
        kwargs.setdefault('omit_join_variables', ['FLAG_M_i_eff_BIN_IND', 'FLAG_v_i_BIN_IND', 'FLAG_n_i_BIN_IND'])
    ...
    def search_data_files(self, file_patterns=None, file_name_by_day=True, archive_yearly=True, **kwargs):
        file_patterns = ['EFI' + self.sat_id.upper(), 'IDM']
