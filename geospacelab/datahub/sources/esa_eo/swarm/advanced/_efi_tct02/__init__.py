...
from geospacelab.datahub.sources.esa_eo.swarm.advanced._efi_tct02.loader import Loader as default_Loader
from geospacelab.datahub.sources.esa_eo.swarm.advanced._efi_tct02.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.esa_eo.swarm.advanced._efi_tct02.variable_config as var_config
...
default_variable_names = [
    'SC_DATETIME', 'SC_GEO_LAT', 'SC_GEO_LON', 'SC_GEO_r', 'SC_GEO_ALT',
    'SC_QD_LAT', 'SC_QD_MLT',
        ...
        if download_obj.done:
            ...
            if download_obj.file_version != self.local_latest_version and self.product_version == 'latest':
                mylog.simpleinfo.warning(
                    f"NOTE: A newer version of data files have been downloaded ({download_obj.file_version})"
                )
