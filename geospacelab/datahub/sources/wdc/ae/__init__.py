...
from geospacelab.datahub.sources.wdc.ae.loader import Loader as default_Loader
from geospacelab.datahub.sources.wdc.ae.downloader import Downloader as default_Downloader
import geospacelab.datahub.sources.wdc.ae.variable_config as var_config
...
default_dataset_attrs = {
    ...
    'product': 'AE',
    'data_file_ext': 'nc',
    'data_root_dir': prf.datahub_data_root_dir / 'WDC' / 'AE',
    'allow_load': True,
    'allow_download': True,
...
default_variable_names = ['DATETIME', 'AE', 'AU', 'AL', 'AO']
