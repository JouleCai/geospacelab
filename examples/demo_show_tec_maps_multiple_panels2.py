...
def test_tec():
    ...
    dt_fr = datetime.datetime(2015, 2, 15, 18)
    ...
    time1 = datetime.datetime(2015, 2, 15, 18, 30)
    ...
    ipc = panel1.add_pcolor(tec_, coords={'lat': glat, 'lon': glon, 'height': 250.}, cs='GEO', shading='auto', **pcolormesh_config)
    ...
    ####
    time1 = datetime.datetime(2015, 2, 15, 18, 50)
    ind_t = np.where(dts == time1)[0]
    ...
    ####
    time1 = datetime.datetime(2015, 2, 15, 19, 10)
    ind_t = np.where(dts == time1)[0]
    ...
    ####
    time1 = datetime.datetime(2015, 2, 15, 19, 30)
    ind_t = np.where(dts == time1)[0]
    ...
    ####
    time1 = datetime.datetime(2015, 2, 15, 19, 50)
    ind_t = np.where(dts == time1)[0]
    ...
    ####
    time1 = datetime.datetime(2015, 2, 15, 20, 10)
    ind_t = np.where(dts == time1)[0]
